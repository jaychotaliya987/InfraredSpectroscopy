...
\begin{figure}[H]
    ...
    \caption[FTIR Schematic of Spectrometer]{Schematic setup of a Michelson interferometer
...
\begin{figure}[H]
    ...
    \caption[Spectra and Interferograms]{Examples of spectra (left) and the corresponding interferograms (right)}
