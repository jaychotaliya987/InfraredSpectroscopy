...
\subsection{Intensity Distribution and $J_{\text{max}}$} \label{Subsec: IntensityDistribution}
...
-
\frac{1}{2}.
\label{equation:Temperature of gas}
\end{equation}
...
\begin{wrapfigure}{R}{0.45\textwidth}
    \centering
    \includegraphics[width=0.43\textwidth]{Michelson_interferometer.png}
    \caption[FTIR Schematic of Spectrometer]{Schematic setup of a Michelson interferometer used in an FTIR spectrometer.}
...
\begin{wrapfigure}{r}{0.5\textwidth} 
    \centering
    \includegraphics[width=0.48\textwidth]{interferogram.png} 
    \caption[Spectra and Interferograms]{Examples of spectra (left) and the corresponding interferograms (right) \cite{Peter}}
    \label{fig:interferogram}
\end{wrapfigure}

\subsection{Lambert--Beer Absorption Law} \label{Subsec: LambertBeer}
...
I(\nu) = I_0(\nu)\,
\exp\left[-\beta(\nu)\, N \right],
\label{Equation: Lambert-Beer Law - coloumn form}
\end{equation}
...
\label{equation: Pressure with altitude}
\end{equation}
